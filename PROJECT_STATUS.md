...
| Visuele wereld en art direction | 10% | 70% | EmberForge heeft een native merkidentiteit, expliciete visuele balans, een eigen typografische stem en zelfstandige wallpapers met functionele muziekinformatie, gecontroleerd licht, Palace lijnarchitectuur, het compacte beverembleem met smidshamer en aambeeld en Noorse vlechtvormen. | De wereldsymboliek moet nog naar andere productsurfaces worden doorgetrokken en de bredere wereldbeschrijving blijft onvolledig. |
