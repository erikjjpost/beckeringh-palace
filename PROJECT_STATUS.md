...
- Actuele milestone: **M11.1c — Homepage visuele hiërarchie** (in uitvoering)
- Laatst voltooid: **M11.2a — Documentatiebasis en productrunbook** (PR #69)
- Volgende stap: **M11.1d — Homepage responsief contract**

## Voortgang per productgebied

| Productgebied | Voortgang | Onderbouwing | Resterend werk |
|---|---:|---|---|
| Compiler en reproduceerbaarheid | 80% | Validatie, deterministische generatie, CI en 140 regressietests vormen een werkende kwaliteitsketen. | Meer producttypen, adapters en volwassen foutdiagnostiek. |
...
| Design System | 60% | Kleur, typografie, spacing, oppervlakken, accenten en varianten zijn technisch beschikbaar; de homepage gebruikt expliciete hero- en routekaartprofielen. | Componentdekking, toestanden, toegankelijkheid en documentatie zijn nog onvolledig. |
...
| HTML homepage | 50% | Vier geordende homepagegebieden dragen inhoudsrol, componentrol, component, variant en appearance; de entree en drie productroutes hebben een expliciete visuele hiërarchie. | Responsief gedrag en de volwaardige wereldpresentatie moeten nog worden verdiept. |
...
### M11.1d — Homepage responsief contract

Responsieve herschikking, focusvolgorde en navigatiegedrag expliciet modelleren en valideren zonder backendafleiding.
