...
def _componentrol_regels(component: DesignComponent) -> list[str]:
    ...
    if component.rol == "terminal":
        return [
            ...
            "}",
            f"{selector} .bp-terminal-controls {{",
            "  display: inline-flex;",
            "  gap: var(--bp-spacing-xs);",
            "}",
            f"{selector} .bp-terminal-control {{",
            "  display: block;",
            "  width: var(--bp-type-caption);",
            "  height: var(--bp-type-caption);",
            "  border-radius: var(--bp-radius-pill);",
            "  background: var(--bp-material-muted);",
            "}",
            (
                f'{selector} [data-terminal-control="sluiten"] '
                "{ background: var(--bp-material-error); }"
            ),
            (
                f'{selector} [data-terminal-control="minimaliseren"] '
                "{ background: var(--bp-material-warning); }"
            ),
            (
                f'{selector} [data-terminal-control="maximaliseren"] '
                "{ background: var(--bp-material-success); }"
            ),
            f"{selector} .bp-terminal-title {{",
            "  color: var(--bp-material-muted);",
            "  font-size: var(--bp-type-caption);",
            "}",
            f"{selector} .bp-terminal-tabs {{",
            "  display: inline-flex;",
            "  gap: var(--bp-spacing-xs);",
            "  margin-left: auto;",
            "}",
            f"{selector} .bp-terminal-tab {{",
            "  padding: var(--bp-spacing-xs) var(--bp-spacing-small);",
            "  color: var(--bp-material-muted);",
            "  border-radius: var(--bp-radius-control);",
            "  font-size: var(--bp-type-caption);",
            "}",
            f'{selector} [data-terminal-tab-active="true"] {{',
            "  color: var(--bp-material-interaction);",
            "  background: var(--bp-material-interaction-soft);",
            "}",
            f"{selector} .bp-terminal-body {{",
            "  display: flex;",
            "  flex-direction: column;",
            "  gap: var(--bp-spacing-medium);",
            ...
            "  line-height: 1.55;",
            "}",
            f"{selector} .bp-terminal-identity,",
            f"{selector} .bp-terminal-prompt {{",
            "  margin: 0;",
            "  font-family: var(--bp-font-mono);",
            "}",
            f"{selector} .bp-terminal-marker,",
            f"{selector} .bp-terminal-prompt-sign {{",
            "  color: var(--bp-material-accent);",
            "}",
            f"{selector} .bp-terminal-user {{",
            "  color: var(--bp-material-foreground);",
            "}",
            f"{selector} .bp-terminal-host,",
            f"{selector} .bp-terminal-path,",
            f"{selector} .bp-terminal-system dt {{",
            "  color: var(--bp-material-interaction);",
            "}",
            f"{selector} .bp-terminal-at,",
            f"{selector} .bp-terminal-separator {{",
            "  color: var(--bp-material-disabled);",
            "}",
            f"{selector} .bp-terminal-rule {{",
            "  border-bottom: var(--bp-border-hairline) var(--bp-border-style) var(--bp-material-outline);",
            "}",
            f"{selector} .bp-terminal-system {{",
            "  display: grid;",
            "  gap: var(--bp-spacing-xs) var(--bp-spacing-medium);",
            "  margin: 0;",
            "}",
            f"{selector} .bp-terminal-field {{",
            "  display: grid;",
            ...
            "  font-weight: 600;",
            "}",
            f"{selector} .bp-terminal-system dd {{",
            "  margin: 0;",
            "  overflow-wrap: anywhere;",
            "  color: var(--bp-material-foreground);",
            "}",
            f"{selector} .bp-terminal-cursor {{",
            "  color: var(--bp-material-foreground);",
            "}",
            "",
        ]
