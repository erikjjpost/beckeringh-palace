...
class ForgeNativeLayoutMigrationTests(unittest.TestCase):
    ...
    def test_forge_dashboard_gebruikt_native_gridcontract(self) -> None:
        ...
        self.assertIn(
            '<p class="bp-metric" data-metric-kind="informatiegebied:forge-design-system">140</p>',
            product.inhoud,
        )
        self.assertIn(
            '<p class="bp-metric" data-metric-kind="informatiegebied:palace-product-family">68</p>',
            product.inhoud,
        )
        self.assertIn(
