...
class ForgeNativeLayoutMigrationTests(unittest.TestCase):
    ...
    def test_forge_dashboard_gebruikt_native_gridcontract(self) -> None:
        ...
        self.assertIn(
            '<p class="bp-metric" data-metric-kind="informatiegebied:palace-world">16</p>',
            product.inhoud,
        )
        self.assertIn(
        ...
        self.assertIn(
            '<p class="bp-metric" data-metric-kind="informatiegebied:palace-product-family">149</p>',
            product.inhoud,
        )
        self.assertIn(
        ...
        self.assertIn(
            ...
            'data-navigation-kind="product">'
            'EmberForge SVG Asset Catalog</a>',
            product.inhoud,
        )
        self.assertIn(
        ...
        self.assertEqual(38, product.inhoud.count('data-content-anchor="'))
