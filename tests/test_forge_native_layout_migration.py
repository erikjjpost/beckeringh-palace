...
class ForgeNativeLayoutMigrationTests(unittest.TestCase):
    ...
    def test_forge_dashboard_gebruikt_native_gridcontract(self) -> None:
        ...
        self.assertIn(
            '<p class="bp-metric" data-metric-kind="informatiegebied:palace-world">12</p>',
            product.inhoud,
        )
        self.assertIn(
        ...
        self.assertIn(
            '<p class="bp-metric" data-metric-kind="informatiegebied:palace-product-family">115</p>',
            product.inhoud,
        )
        self.assertIn(
        ...
        self.assertEqual(33, product.inhoud.count('data-content-anchor="'))
