...
class ProjectStatusTests(unittest.TestCase):
    ...
    def test_status_is_typed_product_context_for_every_backend(self) -> None:
        ...
        def render(_objecten, product):
            ...
            self.assertEqual(87, product.project_status.overall_progress)
            ...
            self.assertEqual(
                "M11.7b", product.project_status.last_completed_milestone.id
            )
            self.assertEqual(
                98, product.project_status.last_completed_milestone.pull_request
            )
